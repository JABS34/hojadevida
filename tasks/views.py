...
def export_pdf(request, username):
    ...
    # Función para convertir 'true'/'false' de la URL en Booleano de Python
    def to_bool(val):
    ...
    context = {
        ...
        # Sincronización exacta con los {% if %} de tu template
...
def dashboard(request):
    ...
    if request.method == 'POST':
        ...
        perfil.direcciondomiciliaria = request.POST.get('direccion')
